      ...
      <section className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-indigo-600 to-purple-700 text-white shadow-2xl">
        ...
        <div className="relative z-10 px-8 py-20 sm:px-16 sm:py-24 lg:py-32 flex flex-col items-start gap-6 max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-indigo-100 max-w-2xl leading-relaxed">
            From tech conferences to underground music festivals, find events
            that match your passion. Join a community of explorers today.
          </p>
          <div className="flex flex-wrap gap-4 mt-4">
            <Button
              type="primary"
              size="large"
              className="bg-white text-indigo-600 hover:bg-gray-100 hover:text-indigo-700 border-none font-bold px-8 h-12 rounded-full shadow-lg shadow-indigo-900/20 flex items-center gap-2"
            >
            ...
            <Button
              ...
              type="default"
              ghost
              className="text-white border-white/40 hover:border-white hover:text-white font-semibold px-8 h-12 rounded-full backdrop-blur-sm"
            >
              Learn More
            </Button>
          </div>
